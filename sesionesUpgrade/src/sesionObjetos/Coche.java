package sesionObjetos;

public class Coche {

    // Lo primero que solemos hacer es declarar qué atributos va a usar nuestra
    // clase.
    private String marca;
    private String modelo;
    private int velocidad;

    // Ahora voy a crear el CONSTRUCTOR de la clase. ESTO es lo que de verdad me
    ...
    // Setters, ayudan a modificar el valor en memoria de los atributos de un
    // objeto.
    ...
    public void acelerar(int incremento) {
        if (incremento > 0) {
            ...
            System.out.println(
                    "El incremento debe ser positivo, por lo que no ha cambiado la velocidad al intentar acelerar.");
        }
    }
    ...
    public void frenar(int decremento) {
        if (decremento > 0 && velocidad - decremento >= 0) {
            ...
            System.out.println(
                    "El decremento debe ser un número positivo, por lo que no ha cambiado la velocidad al intentar frenar.");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Mi coche es un " + miCoche.getMarca() + " " + miCoche.getModelo() + " que ahora va a "
                + miCoche.getVelocidad() + "km/h.");
