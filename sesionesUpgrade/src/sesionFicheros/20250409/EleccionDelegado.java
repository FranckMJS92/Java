...
public class EleccionDelegado {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Si hemos introducido 'fin', terminamos el bucle while (el programa sigue en
            // ejecución)
        ...
        // Imprimimos el resultado recorriendo el diccionario con un for-each (y
        // entrySet)
        ...
        // Imprimimos el resultado recorriendo el diccionario con un Iterator (y
        // entrySet)
