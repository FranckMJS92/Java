...
public class Ejercicio1 {
     ...
     * "calcular"
     * que realice las siguientes operaciones dependiendo del tipo de parámetro
     * recibido:
     *
     * Media (int[]): Calcula la media de un arreglo de números enteros.
     * Moda (double[]): Encuentra el valor más frecuente en un arreglo de números
     * decimales.
     * Mediana (String[]): Determina la mediana (orden alfabético) de un arreglo de
     * cadenas.
     *
     * Requisitos:
     *
     * Implementa tres versiones de la función "calcular" para manejar enteros,
     * decimales y cadenas.
     ...
     * estos cambios no se ven reflejados en el repositorio de forma inmediata, para
     * ello se debe hacer un push.
     * Push: Se cargan los cambios hechos en el proyecto y grabados de forma loca al
     * repositorio git.
     * De este modo los cambios realizados ahora pueden ser vistos por todos
     * aquellos que tengan acceso al repositorio git.
     * Pull: Se cargan al equipo (local) los cambios hecho por ti u otros usuarios
     * que empleen el repositorio
     * y que no se encuentren reflejados en mi equipo. Entiendo que ya sea que hayan
     * o no cambios en el archivo del repositorio, se carga
     * el archivo tal como se encuentra en ese momento en el repositorio a mi equipo
     * para trabajarlo.
     * -----------------------------------------------------------------------------
     * ---------------------------------------------
     */
    ...
    public static String calcular(String[] s) {
        ...
        // Calculo si el tamaño del array es impar, entonces la mediana se encuentra en
        // el medio
        // El calculo seria (tamaño del array -1/ 2)
        if (s.length % 2 != 0)
            mediana = s[(s.length - 1) / 2];
