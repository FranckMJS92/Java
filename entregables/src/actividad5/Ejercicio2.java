...
public class Ejercicio2 {
     ...
     * tomados de k en k utilizando recursividad.
     * Una combinación es un subconjunto de tamaño k extraído de un conjunto den
     * elementos.
     * Requisitos:
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "El total de combinaciones para los parametros ingresados es:" + combinaciones(conjunto, subConjunto));
        scan.close();
    }
