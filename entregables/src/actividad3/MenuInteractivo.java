...
public class MenuInteractivo {
    ...
    // 3.
    // Salir
    // El programa debe permitir al usuario elegir una opción y responder en
    // consecuencia
    // (por ejemplo, “¡Hola!” o “Adiós”). Este menú debe seguir apareciendo hasta
    // que el
    // usuario seleccione la opción “Salir”. Si el usuario selecciona una opción
    // inválida, el
    ...
    public static void main(String[] args) {
        ...
        do {
            // Opciones de Menu
            System.out
                    .println("Hola usuario, elige una de estas 3 opciones (poniendo solo el número correspondiente):");
